...
<%
    ...
    ArrayList<Account> listAc = am.getPaging(p, s, sortColumn);
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h2>List of accounts (<%=am.getNumberOfProduct(p, s, sortColumn)%> Accounts)</h2>
                        <form>
                            <div class="input-group">
                        ...
                        <tr>
                            <th colspan="7" style="text-align: left; padding: 0px;">
                                <%=am.getPagingString(p, s, sortColumn)%>
                            </th>
                        </tr>
                        <!-- Page Heading -->
                        <table class="table"> 
                            ...
                            <tbody> <%
                                ...
                                for (Account acc : listAc) {
                                    ...
                                    if (acc.getGender() == 0) {
                                        Gender = "Male";
                                    } else if (acc.getGender() == 1) {
                                        Gender = "Female";
                                    } else {
                                        Gender = "Other";
                                    }
                                    if (acc.getID_TypeAccount() == 0) {
                                        TypeAccount = "Admin";
                                    } else if (acc.getID_TypeAccount() == 1) {
                                        TypeAccount = "Mode";
                                    } else {
                                        TypeAccount = "Client";
                                    }
